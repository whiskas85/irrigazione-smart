...
from .const import DOMAIN, SERVICE_RUN_ALL, SERVICE_RUN_ZONE, SERVICE_STOP
...
async def async_setup_services(hass: HomeAssistant) -> None:
    ...
    async def _run_all(_call: ServiceCall) -> None:
        executor = get_executor(hass)
    ...
    hass.services.async_register(DOMAIN, SERVICE_RUN_ALL, _run_all)
